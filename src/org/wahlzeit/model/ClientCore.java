...
public class ClientCore implements Client{
	 ...
	 * 
	 */
	protected Map<ClientRole.RoleTypes, ClientRole> roles = new HashMap<ClientRole.RoleTypes, ClientRole>();
	 ...
	 */
	public void initialize(AccessRights myRights, EmailAddress myEmailAddress) {
		rights = myRights;
	...
	public ClientRole addRole(ClientRole.RoleTypes role) {
		...
		ClientRole clientRole = ClientRole.createRole(role, this);
		if (null == clientRole) {
			roles.put(role, clientRole);
		}
		return clientRole;
	}
